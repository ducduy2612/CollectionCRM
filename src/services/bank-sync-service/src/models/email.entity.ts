...
export class Email extends BaseEntity {
  ...
  @ManyToOne(() => Customer, customer => customer.emails, { onDelete: 'CASCADE', nullable: true })
  @JoinColumn({ name: 'cif', referencedColumnName: 'cif' })
  @Index()
  customer?: Customer;

  @ManyToOne(() => ReferenceCustomer, referenceCustomer => referenceCustomer.emails, { onDelete: 'CASCADE', nullable: true })
